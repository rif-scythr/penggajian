		...
		<form method="POST" action="<?php echo base_url('admin/data_pegawai/update_data_aksi')?>" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<select name="statkes" class="form-control">
					<option value="<?php echo $p->statkes?>"><?php echo $p->statkes?></option>
			...
			<div class="form-group">
				<label>Nomor SIP *Jika Tenaga Kesehatan</label>
				<input type="text" name="no_sip" class="form-control" value="<?php echo $p->no_sip?>">
			...
			<div class="form-group">
				...
				<select name="last_edu" class="form-control">
					<option value="<?php echo $p->last_edu?>"><?php echo $p->last_edu?></option>
					<option value="Tenaga Kesehatan">SD/Sederajat</option>
					<option value="Tenaga Kesehatan Lainnya">SMP/Sederajat</option>
					<option value="Non Tenaga Kesehatan">SMA/Sederajat</option>
