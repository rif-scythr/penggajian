  ...
  <div class="card-body">
	...
	<table class="table table-bordered table-striped">
		<tr>
			...
			<td class="text-center">BPJS 4%</td>
			<td class="text-center">JHT 4,24%</td>
			<td class="text-center">JP 2%</td>
			<td class="text-center">BPJS 1%</td>
			<td class="text-center">JHT 2%</td>
			<td class="text-center">JP 1%</td>
			<td class="text-center">CDT</td>
			<td class="text-center">Keterlambatan</td>
			<td class="text-center">Koperasi</td>
			<td class="text-center">Pengobatan Pegawai</td>
		...
		<?php $no=1; foreach($input_absensi as $a) :?>
			<tr>
				...
				<td><input type="number" name="bpjs4[]" class="form-control" value="0"></td>
				<td><input type="number" name="jht424[]" class="form-control" value="0"></td>
				<td><input type="number" name="jp2[]" class="form-control" value="0"></td>
				<td><input type="number" name="bpjs1[]" class="form-control" value="0"></td>
				<td><input type="number" name="jht2[]" class="form-control" value="0"></td>
				<td><input type="number" name="jp1[]" class="form-control" value="0"></td>
				<td><input type="number" name="cdt[]" class="form-control" value="0"></td>
				<td><input type="number" name="keterlambatan[]" class="form-control" value="0"></td>
				<td><input type="number" name="koperasi[]" class="form-control" value="0"></td>
				<td><input type="number" name="pengobatan[]" class="form-control" value="0"></td>
		<?php endforeach; ?>
	</table><br></br><br></br>
	</form>
