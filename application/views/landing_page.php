   ...
   <body>
      ...
      <div class="Header" id="Home">
         <nav class="navbar fixed-top">
            <div class="container">
               <a class="navbar-brand" href="#">SIMPEG RSKDW</a>
               <div class="collapse_menu deactive">
                  ...
                  <ul class="nav">
                     ...
                     <li class="nav-item">
						...
						<a class="nav-button" href=" <?php echo base_url('login');?>">Login</a>
                     </li>
                  </ul>
               </div>
            </div>
         ...
         <div class="banner">
            <div class="layer">
               <div class="row Section">
                  <div class="col">
                     <div class="box">
                        <p>Selamat datang di aplikasi Sistem Informasi Penggajian Karyawan <br>Rumah Sakit Khusus Jiwa Dharmawangsa</p>
                     </div>
                  </div>
                  <!-- <div class="col headerImg" style="background-image: url('<?php echo base_url()?>assets/img/bg-simpeg.svg');"></div> -->
         ...
         <div class="Section">
            <div class="text-center">
               ...
               <div class="subHeading">
                  Berikut informasi lebih lengkap tentang website <br>informasi penggajian karyawan Rumah Sakit Khusus Jiwa Dharmawangsa</div>
            </div>
                  ...
                  <div class="team-memeber col-md-6 col-lg-4 col-xl-3">
                     <div class="card">
                        ...
                        <div class="TeamInfo text-center">
                           ...
                           <div class="Job">Rumah Sakit Khusus Jiwa Dharmawangsa</div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-12 text-center my-3">
                  Copyright &copy; RSK Jiwa Dharmawangsa | SIMRS 2024
               </div>
            </div>
         </div>
      </div>
