...
class Data_Pegawai extends CI_Controller {
	...
	public function tambah_data_aksi() {
		...
		if($this->form_validation->run() == FALSE) {
			...
			$statkes		= $this->input->post('statkes');
	...
	public function _rules() {
		...
		$this->form_validation->set_rules('statkes','Status Nakes','required');
		$this->form_validation->set_rules('no_sip','Nomor SIP','required');
		$this->form_validation->set_rules('last_edu','Pendidikan Terakhir','required');
	}
